...
<head>
    ...
    <title>Helpdesk - Data Kategori</title>
    <!-- Favicon-->
                                        ...
                                        <?php
                                            if($result['hasil'] > 0)
                                            {
                                                ...
                                                foreach($result['data'] as $isidata)
                                                {
                                                    ...
                                                    <tr>
                                                        <td><?php echo $i++;?></td>
                                                        <td><?php echo $isidata->category;?></td>
                                                        <td>
                                                            <center>
                                                                <button class="edit" data-id="<?php echo $isidata->id_category;?>" data-namaka="<?php echo $isidata->category;?>" data-toggle='tooltip' data-placement='bottom' title='Update Data'>
                                                                    <i class='material-icons'>mode_edit</i>
                                                                </button>
                                                                <form onSubmit='return checkSub();' action='<?php echo base_url('app/deleteKat');?>' method='POST' style='display: inline;'>
                                                                    <input type='hidden' class='form-control' name='id_category' value='<?php echo $isidata->id_category;?>'/>
                                            ...
                                            <div id="myModalUp" class="modal">
												<div class="modal-content">
													<div class="modal-header">
														<center><h3>Form Update Data Kategori</h3></center>
													</div>
													<div class="modal-body">
														<form action="<?php echo base_url('app/updateKat');?>" method="POST">
															<div class="form-group">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-line">
                                                                        ...
                                                                        <input type="text" class="form-control kat" name="kat" id="kat" required/>
                                                                    </div>
                                                                    <br>
                                                                </div>
															</div>
											...
											<div id="myModalf" class="modal">
												<div class="modal-content">
													<div class="modal-header">
														...
														<center><h3>Form Tambah Data Kategori</h3></center>
													</div>
													<div class="modal-body">
														<form action="<?php echo base_url('app/createKat');?>" method="POST">
															<div class="form-group">
                                                                <div class="col-sm-12">
                                                                    <div class="form-line">
