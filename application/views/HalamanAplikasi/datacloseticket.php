<?php
    ...
    $result = $this->api_ticket->closeTicket($this->session->userdata('user_id'), $this->session->userdata('user_akses'));
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Helpdesk - Tiket Close</title>
    <!-- Favicon-->
