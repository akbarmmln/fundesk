<?php
	...
	$result = $CI->api_reward->dataReward();
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Helpdesk - Data Reward</title>
    <!-- Favicon-->
                                        ...
                                        <?php
                                            if($result['hasil'] > 0)
                                            {
                                                ...
                                                foreach($result['data'] as $isidata)
                                                {
                                                    ...
                                                    <tr>
                                                        <td><?php echo $i++;?></td>
                                                        <td><?php echo $isidata->reward;?></td>
                                                        <td><?php echo $isidata->poin;?></td>
                                                        <td><center><img width="100" height="100" src="<?php echo 'data:jpeg;base64,'.base64_encode($isidata->gambar);?>"/></center></td>
                                                        <td>
                                                            <center>
                                                                <button class="edit" data-id="<?php echo $isidata->id_reward;?>" data-rw="<?php echo $isidata->reward;?>" data-po="<?php echo $isidata->poin;?>" data-toggle='tooltip' data-placement='bottom' title='Update Data'>
                                                                    <i class='material-icons'>mode_edit</i>
                                                                </button>
                                                                <form onSubmit='return checkSub();' action='<?php echo base_url('app/deleteRaw');?>' method='POST' style='display: inline;'>
                                                                    <input type='hidden' class='form-control' name='id_reward' value='<?php echo $isidata->id_reward;?>'/>
                                            ...
                                            <div id="myModalUp" class="modal">
												<div class="modal-content">
													<div class="modal-header">
														<center><h3>Form Update Data Reward</h3></center>
													</div>
													<div class="modal-body">
														<form action="<?php echo base_url('app/updateRaw');?>" method="POST">
															<div class="form-group">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-line">
                                                                        ...
                                                                        <input type="text" class="form-control rw" name="rw" id="rw" required/>
                                                                    </div>
                                                                    <div class="form-line">
                                                                        <label>Point Rewrd</label>
                                                                        <input type="number" class="form-control po" name="po" id="po" required/>
                                                                    </div>
                                                                    <br>
                                                                </div>
															</div>
											...
											<div id="myModalf" class="modal">
												<div class="modal-content">
													<div class="modal-header">
														...
														<center><h3>Form Tambah Data Reward</h3></center>
													</div>
													<div class="modal-body">
														<form action="<?php echo base_url('app/createRaw');?>" method="POST" enctype="multipart/form-data">
															<div class="form-group">
                                                                <div class="col-sm-12">
                                                                    <div class="form-line">
                                                                        <label>Nama Reward</label>
