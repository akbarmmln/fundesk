...
<head>
    ...
    <title>Helpdesk - Data User</title>
    <!-- Favicon-->
                                        ...
                                        <?php
                                            if($result['hasil'] > 0)
                                            {
                                                ...
                                                foreach($result['data'] as $isidata)
                                                {
                                                    ...
                                                    <tr>
                                                        <td><?php echo $i++;?></td>
                                                        <td><?php echo $isidata->user_first_name.' '.$isidata->user_last_name;?></td>
                                                        <td><?php echo $isidata->address;?></td>
                                                        <td><?php echo $isidata->user_email;?></td>
                                                        <td>
                                                            <?php
                                                            if($isidata->level == 1)
                                                            {
                                                            ...
                                                            else if($isidata->level == 2)
                                                            {
                                                                ?>Staff<?php
                                                            }
                                                            else if($isidata->level == 3)
                                                            {
                                                                ?>Mahasiswa<?php
                                                            }
                                                            else
                                                        ...
                                                        <td><?php echo $isidata->poin_xp;?></td>
                                                        <td><?php echo $isidata->poin_rp;?></td>
                                                        <td>
                                                            <center>
                                                                <button class="edit" data-id="<?php echo $isidata->user_id;?>" data-namafirst="<?php echo $isidata->user_first_name;?>" data-namalast="<?php echo $isidata->user_last_name;?>" data-notelp="<?php echo $isidata->user_phone;?>" data-alamat="<?php echo $isidata->address;?>" data-email="<?php echo $isidata->user_email;?>" data-statusr="" data-xp="<?php echo $isidata->poin_xp;?>" data-rp="<?php echo $isidata->poin_rp;?>" data-toggle='tooltip' data-placement='bottom' title='Update Data'>
                                                                    <i class='material-icons'>mode_edit</i>
                                                                </button>
                                                                <form onSubmit='return checkSub();' action='<?php echo base_url('app/deleteUser');?>' method='POST' style='display: inline;'>
                                                                    <input type='hidden' class='form-control' name='user_id' value='<?php echo $isidata->user_id;?>'/>
                                            ...
                                            <div id="myModalUp" class="modal">
												<div class="modal-content">
													<div class="modal-header">
														<center><h3>Form Update Data User</h3></center>
													</div>
													<div class="modal-body">
														<form action="<?php echo base_url('app/updateUser');?>" method="POST">
															<div class="form-group">
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="form-line">
                                                                        ...
                                                                        <input type="text" class="form-control nmf" name="nmf" id="nmf" required/>
                                                                    </div>
                                                                    <div class="form-line">
                                                                        <label>Nama Akir</label>
                                                                        <input type="text" class="form-control nml" name="nml" id="nml" required/>
                                                                    </div>
                                                                    <div class="form-line">
                                                                        <label>Nomor HP/Telepon</label>
                                                                        <input type="text" class="form-control no" name="no" id="no" required/>
                                                                    </div>
                                                                    <br>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-line">
                                                                        ...
                                                                        <input type="text" class="form-control em" name="em" id="em" required/>
                                                                    </div>
                                                                    <div class="form-line">
                                                                        <label>Alamat Tinggal</label>
                                                                        <textarea class="form-control alt" name="alt" id="alt" required rows="7"></textarea>
                                                                    </div>
                                                                    <br>
                                                                </div>
															</div>
											...
											<div id="myModalf" class="modal">
												<div class="modal-content">
													<div class="modal-header">
														...
														<center><h3>Form Tambah Data User</h3></center>
													</div>
													<div class="modal-body">
														<form action="<?php echo base_url('app/createUser');?>" method="POST">
															<div class="form-group">
                                                                <div class="col-sm-6">
                                                                    <div class="form-line">
                                                                    ...
                                                                    <div class="form-line">
                                                                        ...
                                                                        <select class="form-control" name="statuser" size="1">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <label>Alamat Email</label>
                                                                        <input type="email" class="form-control" name="em" id="em" required/>
                                                                    </div>
                                                                    <div class="form-line">
                                                                        <label>Alamat Tinggal</label>
                                                                        <textarea class="form-control" name="alt" id="alt" required rows="7"></textarea>
                                                                    </div>
                                                                    <br>
                                                                </div>
															</div>
...
<script>
    $(document).ready(function(){
        $('#datatable-responsive').on('click', '.edit', function(){
            var id = $(this).data('id');
            var nmf = $(this).data('namafirst');
            var nml = $(this).data('namalast');
            var no = $(this).data('notelp');
            var alt = $(this).data('alamat');
            var em = $(this).data('email');
            var statusr = $(this).data('statusr');
            var xp = $(this).data('xp');
            var rp = $(this).data('rp');
